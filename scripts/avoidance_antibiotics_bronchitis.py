...
### OBJECTIVE:
    Calculate the Avoidance of Antibiotic Treatment in Adults With Acute Bronchitis HEDIS measure.
...
from ebm_hedis_etc.aab import AAB
...
def main() -> int:
    ...
    dfs_input = {
        ...
        'outclaims': sparkapp.load_df(PRM_META[40, 'out'] / 'outclaims.parquet'),
        'outpharmacy': sparkapp.load_df(PRM_META[40, 'out'] / 'outpharmacy.parquet'),
    ...
    sparkapp.save_df(results_df, PRM_META[150, 'out'] / 'results_aab.parquet')
