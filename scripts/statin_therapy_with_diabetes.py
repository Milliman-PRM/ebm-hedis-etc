...
### OBJECTIVE:
    Calculate the Statin Therapy for Patients with Diabetes (SPD-2) HEDIS measure.
...
from ebm_hedis_etc.spd import SPD
...
def main() -> int:
    ...
    sparkapp.save_df(results_df, PRM_META[150, 'out'] / 'results_spd.parquet')
